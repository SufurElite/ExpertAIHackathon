...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.Sufur.datinganalyst.app";
    private static final String NOTIFICATION_CHANNEL_NAME = "com.Sufur.datinganalyst.app";
